...
Based on the table above, we We anticipate that the crime rate depends on certainty of punishment and severity of punishment. Also, we anticipate that police per capita and density has an impact on the crime rate. As such, our base model includes variables that attempt to operationalize those concepts
...
(cor(cor_model1))
```
<!-- removing since 0.34 isn't high enough for any concern, once it's above 0.9 then we consider removing.  I added the non-logged version for test.
