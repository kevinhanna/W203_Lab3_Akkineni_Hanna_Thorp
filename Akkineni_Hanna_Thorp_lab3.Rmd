...
The density and polpc are very low, whereas the crime rate, probability of arrest, probability of confiction and the percent of minority are similar to other counties. These outliers are all in western counties.  
If we remove those values and plot the graph: 
