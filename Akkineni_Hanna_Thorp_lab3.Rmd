...
#crime <- crime[,c(1,2,3,26,4:13,27,14:25)]
...
## General Crime Prediction Model nolog crime rate
```{r}
general_model = lm(crmrte ~ prbarr + prbconv + log(polpc) + log(pctmin80), data = crime)
general_aic = AIC(general_model)
general_bic = BIC(general_model)
general_rsquared = summary(general_model)[8]
general_adjrsquared = summary(general_model)[9]
...
## General Crime Prediction Model nolog anywhere
```{r}
...
## Simple Crime Prediction Model nonlog crime rate
```{r}
general_model = lm(crmrte ~ prbarr + prbconv + log(polpc) + log(pctmin80), data = crime)
general_aic = AIC(general_model)
general_bic = BIC(general_model)
...
## Simple Crime Prediction Model nonlog anywhere
```{r}
general_model = lm(crmrte ~ prbarr + prbconv + polpc + pctmin80, data = crime)
general_aic = AIC(general_model)
general_bic = BIC(general_model)
