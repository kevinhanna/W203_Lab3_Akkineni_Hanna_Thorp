...
codebook <- read.csv('~/Coding/W203_Lab3_Akkineni_Hanna_Thorp/codebook.csv')
crime <- read.csv('~/Coding/W203_Lab3_Akkineni_Hanna_Thorp/crime_v2.csv')
...
shapiro.test(crime$crmrte)
hist(log(crime$crmrte), xlab = 'log of crimes committed per person', main = 'Histogram of Log of crimes committed per person')
shapiro.test(log(crime$crmrte))
```
Log is preferable - both for interpretation and for better adhering to modeling assumptions

```{r}
hist(crime$prbarr, xlab = 'probability of arrest', main = 'Histogram of probability of arrest')
shapiro.test(crime$prbarr)
hist(log(crime$prbarr), xlab = 'log of probability of arrest', main = 'Histogram of Log of probability of arrest')
shapiro.test(log(crime$prbarr))
```
Log is preferable - both for interpretation and for better adhering to modeling assumptions

```{r}
hist(crime$prbconv, xlab = 'probability of conviction', main = 'Histogram of probability of conviction')
shapiro.test(crime$prbconv)
hist(log(crime$prbconv), xlab = 'log of probability of conviction', main = 'Histogram of Log of probability of conviction')
shapiro.test(log(crime$prbconv))
```
...
```{r}
hist(crime$prbpris, xlab = 'probability of prison', main = 'Histogram of probability of prison')
shapiro.test(crime$prbpris)
hist(log(crime$prbpris), xlab = 'log of probability of prison', main = 'Histogram of Log of probability of prison')
shapiro.test(log(crime$prbpris))
```
...
```{r}
hist(crime$avgsen, xlab = 'average sentence', main = 'Histogram of average sentence')
shapiro.test(crime$avgsen)
hist(log(crime$avgsen), xlab = 'log of average sentence', main = 'Histogram of Log of average sentence')
shapiro.test(log(crime$avgsen))
```
The logged version is preferable from both an interpretation and modeling assumption standpoint.

```{r}
hist(crime$polpc, xlab = 'police as percent of population', main = 'Histogram of police as percent of population')
shapiro.test(crime$polpc)
hist(log(crime$polpc), xlab = 'log of police as percent of population', main = 'Histogram of Log of police as percent of population')
shapiro.test(log(crime$polpc))
```
...
```{r}
hist(crime$pctymle, xlab = 'percent of population that are yound males', main = 'Histogram of percent of population that are yound males')
shapiro.test(crime$pctymle)
hist(log(crime$pctymle), xlab = 'log of percent of population that are yound males', main = 'Histogram of Log of percent of population that are yound males')
shapiro.test(log(crime$pctymle))
```
...
=======
>>>>>>> 798db4e62e6d541b8f06fdccace99016998e1114
