...
Both tax revenue per capita and average wages are positively correlated with people per squre mile.  This is relavent since those are positively correlated with crime rate, the opposite of what we would expect.  Since they are correlated with people per square mile, which is expecantly strongly possitively correlated with crime rate, this will likely account for some of the correlation in tax revenue per capita and average wages, along with some ommited variables discussed later in the analysis. 
